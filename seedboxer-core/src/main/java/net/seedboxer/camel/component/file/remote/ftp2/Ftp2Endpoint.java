...
public class Ftp2Endpoint<T extends FTPFile> extends FtpEndpoint<T> {
    ...
    @Override
    public Ftp2Configuration getConfiguration() {
        if (configuration == null) {
            configuration = new Ftp2Configuration();
        }
        return (Ftp2Configuration)configuration;
    }

    @Override
    public void setConfiguration(GenericFileConfiguration configuration) {
        setConfiguration((Ftp2Configuration)configuration);
    }
