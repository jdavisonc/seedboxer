...
* Continuous Integration: [Jenkins](https://seedboxer.ci.cloudbees.com/) [![Build Status](https://seedboxer.ci.cloudbees.com/job/Seedboxer/badge/icon)](https://seedboxer.ci.cloudbees.com/job/Seedboxer/)
