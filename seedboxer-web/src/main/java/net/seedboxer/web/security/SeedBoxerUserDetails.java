...
import net.seedboxer.web.security.SeedBoxerGrantedAuthority.SeedBoxerAuthority;
...
public class SeedBoxerUserDetails extends User {
	...
	private final net.seedboxer.core.domain.User user;
	...
	private static Collection<? extends GrantedAuthority> createAuthorities(net.seedboxer.core.domain.User user) {
	...
	public net.seedboxer.core.domain.User getUser() {
		return user;
	}
